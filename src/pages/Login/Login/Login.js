...
const Login = () => {
    ...
    return (
        <div className='container w-50 mx-auto'>
            ...
            {errorElement}
            <p className='my-3'>New to <span className='text-success fs-5'>Health Coach</span> ? <Link to="/register" onClick={navigateRegister} className='text-primary text-decoration-none'>Please Register</Link> </p>
